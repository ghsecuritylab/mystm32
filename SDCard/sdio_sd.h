...
#define SDIO_INIT_CLK_DIV           ((uint8_t)0xC2)      /*!< SDIO Intialization Frequency (400KHz max) */
#define SDIO_TRANSFER_CLK_DIV       ((uint8_t)0x02)       /*!< SDIO Data Transfer Frequency (25MHz max)  */
