...
void SPI_FLASH_Init(void)
{
	...
	FLASH_SPI_SCK_APBxClkCmd(FLASH_SPI_SCK_CLK, ENABLE);
	FLASH_SPI_MISO_APBxClkCmd(FLASH_SPI_MISO_PIN, ENABLE);
	FLASH_SPI_MOSI_APBxClkCmd(FLASH_SPI_MOSI_PIN, ENABLE);
