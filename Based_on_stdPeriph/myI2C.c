#include "mylib.h"
// SCL
#define EEPROM_I2C_SCL_APBxClkCmd	RCC_APB2PeriphClockCmd
#define EEPROM_I2C_SCL_CLK 			RCC_APB2Periph_GPIOB
#define EEPROM_I2C_SCL_PORT			GPIOB
#define EEPROM_I2C_SCL_PIN			GPIO_Pin_6
// SDA
#define EEPROM_I2C_SDA_APBxClkCmd	RCC_APB2PeriphClockCmd
...
void I2C_CONFIG()
{
	EEPROM_I2C_SDA_APBxClkCmd(EEPROM_I2C_SDA_CLK, ENABLE);
	EEPROM_I2C_SCL_APBxClkCmd(EEPROM_I2C_SCL_CLK, ENABLE);
	
	GPIO_InitTypeDef gpio_init_t;
	gpio_init_t.GPIO_Mode = GPIO_Mode_AF_OD;	// I2C 必须用复用开漏输出
	gpio_init_t.GPIO_Speed = GPIO_Speed_50MHz;
	
	gpio_init_t.GPIO_Pin = EEPROM_I2C_SCL_PIN;
	GPIO_Init(EEPROM_I2C_SCL_PORT, &gpio_init_t);	// SCL
	
	gpio_init_t.GPIO_Pin = EEPROM_I2C_SDA_PIN;
	GPIO_Init(EEPROM_I2C_SDA_PORT, &gpio_init_t);	// SDA
